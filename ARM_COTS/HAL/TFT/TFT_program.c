 ...
 * v1.0		  05 JUN, 2023	Hossam M. Elzhar		  Initial Creation
*****************************************************************************************/
#include "STD_TYPES.h"
#include "BIT_MATH.h"
...
void HTFT_voidInit(void)
{
    ...
    MGPIO_voidSetOutputSpeed(HTFT_A0_PORT_PIN, MGPIO_LOW_SPEED);
	MGPIO_voidSetOutputSpeed(HTFT_CS_PORT_PIN, MGPIO_LOW_SPEED);
	MGPIO_voidSetOutputSpeed(HTFT_RST_PORT_PIN, MGPIO_LOW_SPEED);

    /*Hardware Reseting*/
    MGPIO_voidSetPinValue(HTFT_RST_PORT_PIN, MGPIO_OUTPUT_HIGH);
    MSYSTICK_voidSetBusyWaitus(100);
    ...
    MSYSTICK_voidSetBusyWaitus(100);
    MGPIO_voidSetPinValue(HTFT_RST_PORT_PIN, MGPIO_OUTPUT_HIGH);
    MSYSTICK_voidSetBusyWaitus(120000);

    HTFT_voidSendCommand(SLPOUT_CMD);
    MSYSTICK_voidSetBusyWaitus(150000);
